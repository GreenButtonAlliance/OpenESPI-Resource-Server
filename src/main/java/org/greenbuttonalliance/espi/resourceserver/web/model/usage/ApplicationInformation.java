...
/**
 * Contains information about a Third Party Application requesting access to the DataCustodian services.
 * Information requested may include items such as Organization Name, Website, Contact Info, Application Name,
 * Description, Icon, Type, default Notification and Callback endpoints, and may also include agreement with
 * terms of service.
 * 
...
public class ApplicationInformation extends IdentifiedObject {
    ...
    @XmlElement(name = "registration_client_uri", required = true)
    protected java.lang.Object registrationClientUri;
    @XmlElement(name = "registration_access_token", required = true)
